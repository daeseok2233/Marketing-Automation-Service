...
- 레퍼런스 기사는 너만 보는 자료. 본문에 절대 언급하지 말 것
  · 금지: "○○일보 기사", "○○ 보도", "기사 제목처럼", "최근 한 기사에서", "이 기사는"  
  · 출처가 꼭 필요하면 일반적 표현만 ("최근 정부 발표", "올해 통계청 자료" 등 — 단, 사실일 때만)  
- 출력 형식 필수 준수:
  · 제목 줄은 반드시 "제목: " 으로 시작
...
- 레퍼런스 기사는 너만 보는 자료. 본문에 절대 언급하지 말 것
  · 금지: "○○일보 기사", "○○ 보도", "기사 제목처럼", "최근 한 기사에서", "이 기사는"
  · 기사에서 얻은 사실/수치/사례를 직접 서술하되, 출처를 본문에 박지 말 것
  · 출처가 꼭 필요하면 일반적 표현만 ("최근 정부 발표", "올해 통계청 자료" 등 — 단, 사실일 때만)
  · 독자는 기사 존재 자체를 모름. "남도일보 기사에서처럼" 같은 표현은 의미 없음
- 출력 형식 필수 준수:
  · 제목 줄은 반드시 "제목: " 으로 시작
  · 소제목 줄은 반드시 "소제목: " 으로 시작 (이 접두어를 떼면 안 됨)
  · 해시태그는 마지막 줄에 # 으로 시작하는 한 줄로
